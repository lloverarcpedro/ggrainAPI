...
const clearWallet = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const wlletlist = yield wallet.list();
        wlletlist.forEach(identity => {
            console.log('Identity to delete: ', identity.toString());
            wallet.delete(identity.label);
        });
        res.send({
            status: 'OK',
            data: 'wallet deleted'
...
exports.default = { enrollAdmin, enrollUser, reenroll, clearWallet };
